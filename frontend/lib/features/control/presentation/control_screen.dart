...
class _ControlScreenState extends State<ControlScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final shelfLabel = provider.current?.shelf.name ?? 'Shelf ${provider.shelfId}';

    return Scaffold(
      appBar: AppBar(
        title: Text('Control · $shelfLabel'),
        actions: [
          IconButton(
...
class _ShelfChipBar extends StatelessWidget {
  const _ShelfChipBar({
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final selected = shelf.id == selectedId;
              return ChoiceChip(
